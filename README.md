...
## This is an application built on NodeJS.
...
Admins can create a sport, create a session by giving the details about the session, join sessions created by others, leave session and cancel the session.
...
Here is the link to the video demonstration : https://drive.google.com/file/d/1CHwesAi2U6HaysqHJSTUBEeX2zXOx-jc/view?usp=drive_link
